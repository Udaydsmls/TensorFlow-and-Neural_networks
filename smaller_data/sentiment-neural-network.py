...
# train_x, train_y, test_x, test_y = create_feature_sets_and_labels('D:/Uday/TT415/pos.txt', 'D:/Uday/TT415/neg.txt')
...
def neural_network_model(data): 
    ...
    hidden_1_layer =\
    {'weights': tf.Variable(tf.random.normal([len(train_x[0]), n_nodes_hl1])),
